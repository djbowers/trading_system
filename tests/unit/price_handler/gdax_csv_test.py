...
class TestGDAXCSVPriceHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.price_handler = price_handler.create_handler(PriceType.GDAX_CSV, EventQueue(), price_data_dir, symbols)
